---
title: "Cart and Checkout: Add Items and Pay with Stripe"
...
Clicking **PROCEED TO CHECKOUT** navigates to `/order`. Unauthenticated users are redirected back to `/cart`.
