---
title: "Authenticate API Requests with JWT Tokens"
sidebarTitle: "Authentication"
description: "Learn how the Food Delivery API issues and verifies JWT tokens for secure access to protected cart and order endpoints."
---
