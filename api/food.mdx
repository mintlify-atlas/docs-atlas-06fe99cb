---
title: "Food Management API: Add, List, and Remove Menu Items"
sidebarTitle: "Food"
description: "Reference for the Food Delivery API food endpoints — upload new items with images, list the full menu catalog, and remove items by MongoDB ID."
---
