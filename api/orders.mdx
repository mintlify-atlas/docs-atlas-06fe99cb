---
title: "Orders API: Place, Verify, and Track Food Delivery"
sidebarTitle: "Orders"
...
<ResponseField name="data" type="array">
  ...
  <Expandable title="Order object">
    ...
    <ResponseField name="amount" type="number">Total order amount in INR as submitted when the order was placed.</ResponseField>
